...
import heroPatioAsset from "@/assets/hero-patio.jpg";
import roomDoubleAsset from "@/assets/room-double.jpg";
import roomTripleAsset from "@/assets/room-triple.jpg";
import roomQuadAsset from "@/assets/room-quad.jpg";
import restaurantAsset from "@/assets/restaurant.jpg";
import terraceAsset from "@/assets/terrace.jpg";
import medinaNightAsset from "@/assets/medina-night.jpg";
import breakfastAsset from "@/assets/breakfast.jpg";
import dinnerZelligeAsset from "@/assets/dinner-zellige.jpg";
import moroccanMealAsset from "@/assets/moroccan-meal.jpg";
import logoAsset from "@/assets/riad-anis-logo.jpg";

const heroPatio = heroPatioAsset;
const roomDouble = roomDoubleAsset;
const roomTriple = roomTripleAsset;
const roomQuad = roomQuadAsset;
const restaurantImg = restaurantAsset;
const terraceImg = terraceAsset;
const medinaNight = medinaNightAsset;
const breakfastImg = breakfastAsset;
const dinnerZellige = dinnerZelligeAsset;
const moroccanMeal = moroccanMealAsset;
